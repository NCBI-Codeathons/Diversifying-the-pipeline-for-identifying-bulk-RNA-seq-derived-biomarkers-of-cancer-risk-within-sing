...
#includes, "donor" defined at the beginning and cluster assignment

#set/list prev qunatitiative data as default (DefaultAssay) 
donors.integrated@assays # RNA and integrated , are available
Assays(donors.integrated)

#all contains cluster assignment as char list
